      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8">
        <Reveal className="max-w-xl">
          ...
          <h2 className="font-display font-semibold text-3xl sm:text-4xl mt-4" style={{ color: C.ink }}>
            We're the one-stop shop for EV charger home installs.
          </h2>
        </Reveal>
...
/* ------------------------------------------------------------------ */
/* Charger Compatibility + Discount                                    */
/* ------------------------------------------------------------------ */
function Brands() {
  return (
    <section id="brands" className="py-20 sm:py-28" style={{ backgroundColor: C.surface }}>
      <div className="max-w-6xl mx-auto px-5 sm:px-8 grid lg:grid-cols-2 gap-10 items-center">
        <Reveal>
          <Eyebrow>Any charger, any home</Eyebrow>
          <h2 className="font-display font-semibold text-3xl sm:text-4xl mt-4" style={{ color: C.ink }}>
            Already have a charger? We install it.
          </h2>
          <p className="mt-3 text-base leading-relaxed" style={{ color: C.inkSoft }}>
            We're compatible with virtually every major EV charger on the market, so whatever you've picked out, we can install it.
          </p>
        </Reveal>
        <Reveal delay={100}>
          <div className="rounded-2xl p-7" style={{ backgroundColor: C.ink }}>
            <div className="flex items-center gap-2 mb-2">
              <Zap size={18} color={C.volt} />
              <span className="text-xs font-mono uppercase tracking-wide text-white/60">Don't have one yet?</span>
            </div>
            <p className="text-white text-base leading-relaxed">
              Let us provide it. Because we buy chargers in volume, we get pricing that isn't available to the general public — and we pass that discount on to you as part of your quote.
            </p>
          </div>
        </Reveal>
      </div>
    ...
    <section className="py-20 sm:py-28" style={{ backgroundColor: C.white }}>
      <div className="max-w-6xl mx-auto px-5 sm:px-8 grid lg:grid-cols-2 gap-12 items-center">
        <Reveal>
          ...
          <h2 className="font-display font-semibold text-3xl sm:text-4xl mt-4" style={{ color: C.ink }}>
            We install anywhere in Michigan.
          </h2>
          <p className="mt-4 text-base leading-relaxed max-w-md" style={{ color: C.inkSoft }}>
            From Detroit to Grand Rapids and everywhere in between — if you're a Michigan homeowner, we cover you. No location is too far.
          </p>
        </Reveal>
        <Reveal delay={120}>
...
const FORMSPREE_ENDPOINT = "https://formspree.io/f/xrewygeo";
            ...
            <form onSubmit={handleSubmit} className="rounded-2xl p-6 sm:p-8 space-y-5" style={{ backgroundColor: C.white, border: `1px solid ${C.line}` }}>
              <div className="grid sm:grid-cols-2 gap-5">
                <div>
                  ...
                  <input required name="name" type="text" className="w-full rounded-lg px-4 py-2.5 text-sm outline-none" style={inputStyle} placeholder="Jane Doe" />
                </div>
                <div>
                  <FieldLabel>Phone</FieldLabel>
                  <input required name="phone" type="tel" className="w-full rounded-lg px-4 py-2.5 text-sm outline-none" style={inputStyle} placeholder="(313) 555-0134" />
                </div>
              </div>

              <div>
                <FieldLabel>Email</FieldLabel>
                <input required name="email" type="email" className="w-full rounded-lg px-4 py-2.5 text-sm outline-none" style={inputStyle} placeholder="jane@email.com" />
              </div>

              <div>
                <FieldLabel>Home address</FieldLabel>
                <input required name="address" type="text" className="w-full rounded-lg px-4 py-2.5 text-sm outline-none" style={inputStyle} placeholder="123 Main St, Farmington Hills, MI" />
              </div>

              <div className="grid sm:grid-cols-2 gap-5">
                <div>
                  <FieldLabel>Vehicle</FieldLabel>
                  <select required name="vehicle" className="w-full rounded-lg px-4 py-2.5 text-sm outline-none" style={inputStyle} defaultValue="">
                    <option value="" disabled>Select your vehicle</option>
                    {vehicles.map((v) => (<option key={v} value={v}>{v}</option>))}
                  </select>
                </div>
                <div>
                  <FieldLabel>Do you already have a charger?</FieldLabel>
                  <select
                    required
                    name="charger_status"
                    ...
                    style={inputStyle}
                    defaultValue=""
                    onChange={(e) => setHasCharger(e.target.value)}
                  >
                    <option value="" disabled>Select an option</option>
                    <option value="I already have a charger">I already have a charger</option>
                    <option value="Provide one for me (member pricing)">Provide one for me (member pricing)</option>
                    <option value="Not sure yet">Not sure yet</option>
                  </select>
                </div>
              </div>

              {hasCharger === "I already have a charger" && (
                <div>
                  <FieldLabel>Charger brand</FieldLabel>
                  <select name="charger_brand" className="w-full rounded-lg px-4 py-2.5 text-sm outline-none" style={inputStyle} defaultValue="">
              ...
              {hasCharger === "Provide one for me (member pricing)" && (
                <div className="rounded-lg px-4 py-3 text-sm" style={{ backgroundColor: C.voltSoft, color: C.voltDeep }}>
                  Good news — we buy chargers in volume and pass the discount to you. We'll recommend the right charger for your setup and include member pricing in your quote.
                </div>
              )}
              ...
              <div>
                ...
                <textarea name="message" rows={3} className="w-full rounded-lg px-4 py-2.5 text-sm outline-none resize-none" style={inputStyle} placeholder="Garage is detached, panel is in the basement, etc." />
              </div>

              {error && (
                <div className="rounded-lg px-4 py-3 text-sm" style={{ backgroundColor: "#FDECEC", color: "#B42318" }}>
                  {error}
                </div>
              )}
              ...
              <button
                type="submit"
                disabled={submitting}
                className="w-full rounded-full font-semibold py-3.5 text-base transition-all duration-200 hover:-translate-y-0.5 disabled:opacity-60 disabled:hover:translate-y-0"
                style={{ backgroundColor: C.volt, color: C.white, boxShadow: "0 8px 24px rgba(29,95,255,0.28)" }}
              >
